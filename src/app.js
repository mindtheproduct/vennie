...
const { getWelcomeSuggestions, getResponseSuggestions, getIdleHint, getOnboardingTip } = require('./suggestions.js');
const { searchVault, rebuildIndex } = require('./search.js');
const { saveSessionMemory, getMemoryContext, pruneOldMemories } = require('./memory.js');
const { detectIntent, formatIntentSuggestion } = require('./intent.js');
const { getVaultPulse, quickCapture, parseLogCommand } = require('./vault-pulse.js');
const { getPersonaContext, incrementSessionCount } = require('./persona-memory.js');
const { generateMorningBrief, formatBriefForDisplay, shouldShowBrief } = require('./morning-brief.js');
const { buildSimulationContext, listSimulatableStakeholders } = require('./stakeholder-sim.js');
const { analyseDecisions, formatPatternReport, detectMissingContext } = require('./decision-patterns.js');
const { gatherContext, formatContextBlock, shouldInjectContext } = require('./auto-context.js');
const { findExpertise, getRelationshipMap, formatNetworkResponse } = require('./network-recall.js');
const { addCompetitor, removeCompetitor, checkCompetitors, listCompetitors, formatRadarReport } = require('./competitive-radar.js');
const { generateExercise, markExerciseCompleted, getStreak, formatExercise } = require('./product-gym.js');
const { captureShipment, suggestSkillFromDescription, getCareerTimeline, getSkillMatrix, formatCareerSummary } = require('./ship-to-story.js');
